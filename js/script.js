...
$('.my-foto').click(function() {
  $('.my-foto').removeClass('foto-active');
...
$(function() {
  $(".gal__close").click(function() {
    $(".gal__body").removeClass("gal__body-active");
    $(".gal__wrapper").removeClass("gal__wrapper-active");
    $("body").removeClass("body__stop-scroll");
  });
  $(".open__gal").click(function () {
    $(".gal__body").addClass("gal__body-active");
    $(".gal__wrapper").addClass("gal__wrapper-active");
